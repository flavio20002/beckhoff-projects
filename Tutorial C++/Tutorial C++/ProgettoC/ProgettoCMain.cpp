...
class CProgettoCCtrl : public ITcOCFCtrlImpl<CProgettoCCtrl, CProgettoCClassFactory>
{
public:
	CProgettoCCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("ProgettoC: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CProgettoCCtrl>;
